...
class Config {
  ...
  validateKeyConfig() {
    ...
    assert(this.key.template,
      'key config property `template` must be defined (as a string)')
    assert(this.key.itemTemplate,
      'key config property `itemTemplate` must be defined (as a string)')
    assert(this.key.listWrapperClass,
      'key config property `listWrapperClass` must be defined (as a string)')
  }
